...
local _2amodule_name_2a = "explaindev.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("explaindev.aniseed.core"), autoload("explaindev.aniseed.fennel"), autoload("explaindev.aniseed.fs"), autoload("explaindev.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "explaindev.aniseed.macros"
  local filename
  do
