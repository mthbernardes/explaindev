...
local _2amodule_name_2a = "explaindev.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("explaindev.aniseed.core"), autoload("explaindev.aniseed.compile"), autoload("explaindev.aniseed.fennel"), autoload("explaindev.aniseed.fs"), autoload("explaindev.aniseed.nvim")
