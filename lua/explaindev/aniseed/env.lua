...
local _2amodule_name_2a = "explaindev.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("explaindev.aniseed.compile"), autoload("explaindev.aniseed.fennel"), autoload("explaindev.aniseed.fs"), autoload("explaindev.aniseed.nvim")
