...
local _2amodule_name_2a = "explaindev.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("explaindev.aniseed.core"), autoload("explaindev.aniseed.env"), autoload("explaindev.aniseed.eval"), autoload("explaindev.aniseed.nvim")
