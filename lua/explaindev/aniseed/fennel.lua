...
local _2amodule_name_2a = "explaindev.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("explaindev.aniseed.core"), autoload("explaindev.aniseed.fs"), autoload("explaindev.aniseed.nvim"), autoload("explaindev.aniseed.string")
...
local function impl()
  local compiler = require("explaindev.aniseed.deps.fennel")
