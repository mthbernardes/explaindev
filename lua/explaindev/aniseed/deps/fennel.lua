package.preload["explaindev.aniseed.fennel.repl"] = package.preload["explaindev.aniseed.fennel.repl"] or function(...)
  local utils = require("explaindev.aniseed.fennel.utils")
  local parser = require("explaindev.aniseed.fennel.parser")
  local compiler = require("explaindev.aniseed.fennel.compiler")
  local specials = require("explaindev.aniseed.fennel.specials")
  local view = require("explaindev.aniseed.fennel.view")
...
package.preload["explaindev.aniseed.fennel.specials"] = package.preload["explaindev.aniseed.fennel.specials"] or function(...)
  local utils = require("explaindev.aniseed.fennel.utils")
  local view = require("explaindev.aniseed.fennel.view")
  local parser = require("explaindev.aniseed.fennel.parser")
  local compiler = require("explaindev.aniseed.fennel.compiler")
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "explaindev.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["explaindev.aniseed.fennel.compiler"] = package.preload["explaindev.aniseed.fennel.compiler"] or function(...)
  local utils = require("explaindev.aniseed.fennel.utils")
  local parser = require("explaindev.aniseed.fennel.parser")
  local friend = require("explaindev.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["explaindev.aniseed.fennel.friend"] = package.preload["explaindev.aniseed.fennel.friend"] or function(...)
  local utils = require("explaindev.aniseed.fennel.utils")
...
package.preload["explaindev.aniseed.fennel.parser"] = package.preload["explaindev.aniseed.fennel.parser"] or function(...)
  local utils = require("explaindev.aniseed.fennel.utils")
  local friend = require("explaindev.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["explaindev.aniseed.fennel.view"] = package.preload["explaindev.aniseed.fennel.view"] or function(...)
...
package.preload["explaindev.aniseed.fennel.utils"] = package.preload["explaindev.aniseed.fennel.utils"] or function(...)
  local view = require("explaindev.aniseed.fennel.view")
  local version = "1.3.0"
...
utils = require("explaindev.aniseed.fennel.utils")
local parser = require("explaindev.aniseed.fennel.parser")
local compiler = require("explaindev.aniseed.fennel.compiler")
local specials = require("explaindev.aniseed.fennel.specials")
local repl = require("explaindev.aniseed.fennel.repl")
local view = require("explaindev.aniseed.fennel.view")
...
do
  local module_name = "explaindev.aniseed.fennel.macros"
  local _
